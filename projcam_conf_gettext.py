...
def get_simple_test_set():
    ...
    train, val = train_test_split(doit.df, test_size=0.1, random_state=42)
    #print(train)
...
#=============================================================================
    ...
    val_vectorizer = CountVectorizer(stop_words="english", max_features=100, vocabulary=train_vocab)
